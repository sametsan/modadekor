...
$db->query("INSERT INTO odemeler (ad,aciklama,fiyat,asgari,azami) VALUES ('$post->ad','$post->aciklama','$post->fiyat','$post->asgari','$post->azami')");
...
$db->query("DELETE FROM odemeler WHERE no='$get->no'");
...
$db->query("UPDATE odemeler SET ad='$post->ad' WHERE no='$get->no'");
$db->query("UPDATE odemeler SET aciklama='$post->aciklama' WHERE no='$get->no'");
$db->query("UPDATE odemeler SET fiyat='$post->fiyat' WHERE no='$get->no'");
$db->query("UPDATE odemeler SET azami='$post->azami' WHERE no='$get->no'");
$db->query("UPDATE odemeler SET asgari='$post->asgari' WHERE no='$get->no'");
