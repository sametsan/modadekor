...
document.getElementById("siparis_dugme_"+no).innerHTML="  <a onclick=\"uye_siparis_gizle("+no+")\">K</a>";
}
...
document.getElementById("siparis_dugme_"+no).innerHTML="  <a  onclick=\"uye_siparis_goster("+no+")\">A</a>";
}
