...
$urun = Api\Records::get(Url::$params[0]);
...
$image_list = Storage::getAllByRecordId($urun->id);
...
foreach($image_list as $image){
    ...
    $image_url = Storage::url($image->file);
    $image_path = Storage::fullPath($image->file);

    $genislik = getimagesize($image_path);
    if ($genislik[0] > 960)
        print "<a href=$image_url rel='lytebox[onder]'  ><img  width=100% src=$image_url border=0>&nbsp;</a><br>";
    else
        print "<a href=$image_url rel='lytebox[onder]'  ><img   src=$image_url border=0>&nbsp;</a><br>";
