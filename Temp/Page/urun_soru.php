...
switch ($get->uyari) {
    case 1:
        echo "<div class=uyari>İşleminiz tamamdır.</div>";
        break;
    case 2:
        echo "<div class=uyari>Boşlukları doldurun.</div>";
        break;
    case 3:
        echo "<div class=uyari>15 sn sonra deneyin.KORUMA!!!</div>";
        break;
}
...
echo "<table border=0>";
if ($get->urun) {
    $sql = $db->query("SELECT * FROM urunler WHERE no=$get->urun");
    $urun = $sql->fetch_object(;
